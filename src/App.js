...
// import Asia from './json/Asia.json'
...
//    console.log("worldData:=" + res.data.data.FAutoGlobalStatis)
...
//         "Zimbabwe": "津巴布韦"
//       }
//      }else if(this.props.data==='sevenContinentsWorld'){
//       max=200000
//       show=false
//       text='世界七大洲地图'
//       name={
...
//         header:worldHeader
//       })
//     }else if(e.key === 'sevenContinentsWorld'){
//       this.setState({
//         dataSource:worldList,
//         dataMap:worldMap,
//         header:worldHeader
